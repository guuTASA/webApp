...
#dict有一个get方法，如果dict中有对应的value值，则返回对
#应于key的value值，否则返回默认值，例如下面的host，如果
#dict里面没有'host',则返回后面的默认值，也就是'localhost'
#这里有一个关于Pool的连接，讲了一些Pool的知识点，挺不错的，
#点击打开链接，下面这些参数都会讲到，以及destroy__pool里面的
#wait_closed()
